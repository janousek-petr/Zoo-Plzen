...
export default function AddQuestion({ quizId }: { quizId: number }) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError('Nepodařilo se vytvořit otázku.')
        } finally {
            setLoading(false)
        }
    }
    ...
    return (
        <div className="max-w-xl ml-5">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                {/* Odpovědi – různé UI podle kategorie */}
