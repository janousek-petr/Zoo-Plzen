                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            {questions.map((question, index) => (
                                <div key={question.id} className="bg-white border border-gray-200 rounded-xl p-4">
                                    ...
                                    {/* Obrázek nebo Audio přímo k otázce */}
                                    {question.image && (
                                        <MediaPreview
                                    ...
                                    {question.audio && (
                                        <div className="mb-3" onClick={e => e.stopPropagation()} onMouseDown={e => e.stopPropagation()}>
                                            <MediaPreview
                                                path={question.audio}
                                            />
                                        </div>
                                        ...
                                        {question.answers.map(answer => {
                                            return (
                                                ...
                                                >
                                                    ...
                                                    {/* Zobrazení audia v odpovědi */}
                                                    {answer.audio && (
                                                        <div className="flex-1 max-w-xs" onClick={e => e.stopPropagation()} onMouseDown={e => e.stopPropagation()}>
                                                            <MediaPreview
                                                                path={answer.audio}
                                                            />
                                                        </div>
