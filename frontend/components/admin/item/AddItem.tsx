...
export default function AddItem({ categoryId }: { categoryId: number }) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError('Nepodařilo se vytvořit předmět.')
        } finally {
            setLoading(false)
        }
    }
        ...
        <div className="max-w-xl ml-5">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className="bg-green-700 hover:bg-green-800 text-white font-semibold py-4 px-4 rounded-xl disabled:opacity-50"
                >
